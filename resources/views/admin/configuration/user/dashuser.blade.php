...
@section('breadcrumb')
	<li class="breadcrumb-item">
	  <a href="{{ url('/admin/users') }}"><i class="far fa-folder-open"></i> Usuarios</a>
	</li>
@endsection	
...
<div class="row">
	...
	<section class="col-md-8 connectedSortable ui-sortable">
		<div class="box card shadow footer-line">
			<div class="card-body">
				<div class="shadow border-all-10" style="font-weight: bold; text-align: center; background-color: #4A96FF">Usuario</div>
				<div class="inside">
