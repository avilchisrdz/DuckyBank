...
@section('breadcrumb')
	<li class="breadcrumb-item">
	  <a href="{{ url('/admin/roles') }}"><i class="far fa-folder-open"></i> Roles</a>
	</li>
@endsection	
...
<div class="row">
	<section class="col-md-4 connectedSortable ui-sortable">
		...
		<div class="box card shadow footer-line">
			<div class="card-header">Agregar role</div>
			<div class="card-body">
				<div class="inside">
					...
					<label for="description">Ingresa role:</label>
						<div class="input-group">
							...
							{!! Form::text('description', null, array('class ' => 'form-control text-inside', 'placeholder' => 'Role')) !!}
						</div>																						
	...
	<section class="col-md-8 connectedSortable ui-sortable">
		<div class="box card shadow footer-line">
			<div class="card-body">
				<div class="shadow border-all-10" style="font-weight: bold; text-align: center; background-color: #4A96FF">Role</div>
				<div class="inside">
